module.exports = {
  ...
  saveError: "Une erreur est survenue lors de l'enregistrement. Veuillez reconfigurer la valeur que vous étiez en train d'essayer de modifier. Si cette erreur persiste, veuillez contactez [support]({support}). Excusez nous du désagrément.",
  format: {
    spotify: "URL invalide. Les URLs Spotify ressemblent normalement à ceci: **https://open.spotify.com/artist/ID_ICI**.",
  ...
  feedback: {
    name: "Avis",
    content: "Contenu",
    cooldown: "Vous avez déjà envoyé un commentaire récemment ! Veuillez patienter **{minutes} minutes** et **{seconds} secondes**."
  },
  socialSelect: {
