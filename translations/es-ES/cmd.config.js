module.exports = {
  ...
  feedback: {
    name: "Comentarios",
    content: "Contenido",
    cooldown: "¡Ya has enviado comentarios recientemente! Por favor, espera **{minutes} minutos** y **{seconds} segundos**."
  },
  socialSelect: {
